...
public class BreakoutBoard extends JPanel implements Comparable<BreakoutBoard>{
	...
	@Override
	public int compareTo(BreakoutBoard b){ return (int)(b.getFitness()-this.getFitness());}
}
